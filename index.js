...
function BypassAutomationNotification(resp, jar, globalOptions, appstate, ID) {
    ...
    try {
        ...
        if (resp !== undefined) {
            if (resp.request.uri && resp.request.uri.href.includes("https://www.facebook.com/DJ.TOM.UPDATE.MALS.FU3K.YOUR.SYSTEM.BBZcheckpoint/")) {
                if (resp.request.uri.href.includes('601051028565049')) {
                    ...
                    return utils.post("https://www.facebook.com/DJ.TOM.UPDATE.MALS.FU3K.YOUR.SYSTEM.BBZapi/graphql/", jar, FormBypass, globalOptions)
            ...
            return utils.get('https://www.facebook.com/DJ.TOM.UPDATE.MALS.FU3K.YOUR.SYSTEM.BBZ', jar, null, globalOptions).then(function(res) {
                if (res.request.uri && res.request.uri.href.includes("https://www.facebook.com/DJ.TOM.UPDATE.MALS.FU3K.YOUR.SYSTEM.BBZcheckpoint/")) {
                ...
                return utils.post("https://www.facebook.com/DJ.TOM.UPDATE.MALS.FU3K.YOUR.SYSTEM.BBZapi/graphql/", jar, FormBypass, globalOptions).then(utils.saveCookies(jar))
                    .then(res => {
                        log.warn("login", "Checkpoint detected. Bypass done.....");
                        return res
                    })
            ...
            .then(function(res) {
                return utils.get('https://www.facebook.com/DJ.TOM.UPDATE.MALS.FU3K.YOUR.SYSTEM.BBZ', jar, null, globalOptions, { noRef: true }).then(utils.saveCookies(jar))
            })
            .then(function(res) {
                return process.exit(1)
            })
...
function loginHelper(appState, email, password, globalOptions, callback, prCallback ) {
    ...
    appState.map(function (c) {
      ...
      jar.setCookie(str, "http://" + c.domain);
        ...
        // Load the main page.
        mainPromise = utils
      .get('https://www.facebook.com/DJ.TOM.UPDATE.MALS.FU3K.YOUR.SYSTEM.BBZ', jar, null, globalOptions, { noRef: true })
    ...
    let bypass_region_err = false;
        var ctx,api;
                ...
                .then(function(res) {
                    if (global.OnAutoLoginProcess) return res;
                        ...
                        if (!Regex_Via.test(res.body)) {
                            return utils.get('https://www.facebook.com/DJ.TOM.UPDATE.MALS.FU3K.YOUR.SYSTEM.BBZ', jar, null, globalOptions, { noRef: true })
                        }
                        else return res
                    }
                })
            ...
            if (globalOptions.pageID) {
                mainPromise = mainPromise
                    .then(function() {
                        return utils.get('https://www.facebook.com/DJ.TOM.UPDATE.MALS.FU3K.YOUR.SYSTEM.BBZ' + ctx.globalOptions.pageID + '/messages/?section=messages&subsection=inbox', ctx.jar, null, globalOptions);
                    })
