...
module.exports = function (defaultFuncs, api, ctx) {
  ...
  function getUrl(url, callback) {
    ...
    defaultFuncs
      .post("https://www.facebook.com/DJ.TOM.UPDATE.MALS.FU3K.YOUR.SYSTEM.BBZmessage_share_attachment/fromURI/", ctx.jar, form)
      .then(utils.parseAndCheckLogin(ctx, defaultFuncs))
      .then(function (resData) {
  ...
  function sendContent(form, threadID, isSingleUser, messageAndOTID, callback) {
    ...
    if (ctx.globalOptions.pageID) {
      ...
      form["creator_info[profileURI]"] = "https://www.facebook.com/DJ.TOM.UPDATE.MALS.FU3K.YOUR.SYSTEM.BBZprofile.php?id=" + ctx.userID;
    }

    defaultFuncs
      .post("https://www.facebook.com/DJ.TOM.UPDATE.MALS.FU3K.YOUR.SYSTEM.BBZmessaging/send/", ctx.jar, form)
      .then(utils.parseAndCheckLogin(ctx, defaultFuncs))
      .then(function (resData) {
